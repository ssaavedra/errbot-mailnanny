"""
    MailNanny.py for Errbot
    Copyright (C) 2018  Santiago Saavedra <ssaavedra at gpul dot org>
   ...
   You can find the repository for this software at: https://github.com/ssaavedra/errbot-mailnanny/
"""
